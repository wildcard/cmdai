...
fn bench_concurrent_validation(c: &mut Criterion) {
    ...
    let commands = vec![
        "echo concurrent1", "echo concurrent2", "echo concurrent3",
        "ls -la", "pwd", "date", "whoami", "uptime", "df -h", "free -m"
    ];
            ...
            rt.block_on(async {
                ...
                if validator.is_ok() {
                    ...
                    for _ in 0..iters {
                        ...
                        let commands = vec![
                            "ls -la", "pwd", "echo test", "date", "whoami",
                            "rm temp.txt", "mkdir test", "cp file1 file2",
                        ];
